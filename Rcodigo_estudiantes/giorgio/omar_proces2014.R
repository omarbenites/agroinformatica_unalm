...
#dtsowa <- dplyr::slice(dct, 1:30) #nota: este patron funciona bien desde 2005 hasta el 2010
#dtsowa <- dplyr::slice(dct, 1:32)#aplicable del 2011 para adelante
dtsowa <- dplyr::slice(dct, 1:27)  #2014
...
#dtharva <- dplyr::slice(dct, 31:60) # funciona desde el 2005 al 2010
# cabezeras de la tabla harva
#dtharva <- dplyr::slice(dct, 33:64) 

dtharva <- dplyr::slice(dct, 28:54)  #2014
...
#dtyield <- dplyr::slice(dct, 91:120) (2005-2010)
...
#dtpricePlot <- dplyr::slice(dct, 121:150)     (2005-2010)

#dtpricePlot <- dplyr::slice(dct, 129:161)
dtpricePlot <- dplyr::slice(dct, 109:127) #2014
...
tbcamote <- tbcamote %>% mutate(year = 2014)


# Guardar tabla cultivo ---------------------------------------------------

wb <- loadWorkbook(fp2)
cult_sheet <- "camote_proc_2014"
