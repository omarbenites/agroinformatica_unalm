...
# #dtsowa <-slice(dct, 1:30) # del 2005 hasta el 2010
# #dtsowa <-slice(dct, 1:32) #2011, 2012, 2013
# dtsowa <-slice(dct, 1:27)  #2014 
# 
# 
...
# 
# #dtharva <- dplyr::slice(dct, 31:60) # Del 2005 hasta el 2010
# #dtharva <- dplyr::slice(dct, 33:64) # 2011, 2012, 2013
# dtharva <- slice(dct, 28:54)  # 2014
# 
# 
...
# 
# # Seleccionamos las siguientes 29 filas: del 31 al 60
# #dtproduction <- dplyr::slice(dct, 61:90) # Del 2005 hasta el 2010
# #dtproduction <- dplyr::slice(dct, 65:96) # del 2011, 2012 y 2013
# dtproduction <- dplyr::slice(dct, 55:81)  # 2014
# 
# # cabezeras de la tabla harva
...
# # yield -------------------------------------------------------------------
# 
# #dtyield <- dplyr::slice(dct, 91:120) # Del 2005 hasta el 2010
# #dtyield <- dplyr::slice(dct, 97:128) # del 2010, 2011, 2012
# dtyield <- dplyr::slice(dct, 82:108)  # 2014 
# 
# # cabezeras de la tabla harva
...
# # pricePlot ---------------------------------------------------------------
# 
# #dtpricePlot <- dplyr::slice(dct, 122:155) # Del 2005 hasta el 2010
# #dtpricePlot <- dplyr::slice(dct, 129:161) # 2011 , 2012 y 2013
# dtpricePlot <- dplyr::slice(dct, 109:137)  # 2014
# 
# # cabezeras de la tabla harva
...
# #tbtomate <- tbtomate %>% mutate(year = 2006)
# #tbtomate <- tbtomate %>% mutate(year = 2007)
# #tbtomate <- tbtomate %>% mutate(year = 2008)
# #tbtomate <- tbtomate %>% mutate(year = 2009)
# #tbtomate <- tbtomate %>% mutate(year = 2010)
# #tbtomate <- tbtomate %>% mutate(year = 2011)
# #tbtomate <- tbtomate %>% mutate(year = 2012)
# #tbtomate <- tbtomate %>% mutate(year = 2013)
# tbtomate <- tbtomate %>% mutate(year = 2014)
# 
# # Guardar tabla cultivo ---------------------------------------------------
# 
#  wb <- loadWorkbook(fp2)
#  #cult_sheet <- "tomate_proc_2006"
#  #cult_sheet <- "tomate_proc_2007"
#  #cult_sheet <- "tomate_proc_2008"
#  #cult_sheet <- "tomate_proc_2009"
#  #cult_sheet <- "tomate_proc_2010"
#  #cult_sheet <- "tomate_proc_2011"
#  #cult_sheet <- "tomate_proc_2012"
#  #cult_sheet <- "tomate_proc_2013"
#  cult_sheet <- "tomate_proc_2014"
# 
